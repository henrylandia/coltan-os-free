...
function initSchema() {
  ...
  try { db.exec('ALTER TABLE attack_log ADD COLUMN threat_key TEXT') } catch(e) {}
  try { db.exec('ALTER TABLE attack_log ADD COLUMN threat_label TEXT') } catch(e) {}
  try { db.exec('ALTER TABLE attack_log ADD COLUMN threat_icon TEXT') } catch(e) {}
