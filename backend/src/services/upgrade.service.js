...
async function isUpgradeAvailable() {
  ...
  // Marcador confiable: collectors.service.js SOLO existe tras un upgrade real a premium
  // (middleware/license.js NO sirve como marcador porque es identico en free y premium)
  const premiumMarker = '/opt/coltanos/backend/src/services/collectors.service.js'
  if (fs.existsSync(premiumMarker)) {
